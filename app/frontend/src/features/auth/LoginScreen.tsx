...
export default function LoginScreen() {
  return (
    <div className="min-h-screen bg-slate-100 flex justify-center">
      <PhoneFrame className="bg-slate-100 overflow-hidden">
        <ScreenHeader className="bg-slate-100/90 border-slate-200">
        ...
        <section className="mx-6 mb-6 mt-4 p-6 bg-white rounded-xl shadow-lg relative z-10 flex flex-col gap-4">
          ...
          <button className="flex w-full items-center justify-center gap-2 rounded-xl bg-slate-800 px-6 py-4 text-base font-bold leading-normal text-white shadow-lg shadow-slate-800/20 hover:bg-slate-700 hover:shadow-slate-800/30 active:scale-[0.98] transition-all">
            ログイン
          </button>
          ...
          <button className="flex w-full items-center justify-center gap-3 rounded-xl border border-slate-200 bg-white px-6 py-3.5 text-base font-medium leading-normal text-slate-600 hover:bg-slate-50 transition-colors">
            <img
              alt="Google Logo"
              className="h-5 w-5"
        ...
        <section className="flex flex-col items-center justify-center py-6 px-4 pb-8 bg-slate-100">
          <p className="text-sm text-slate-500">
            アカウントをお持ちでないですか？{' '}
            <a className="font-bold text-slate-800 hover:underline" href="#">
              新規登録はこちら
            </a>
          </p>
        </section>
